        ...
        }, // End navigation
        {
            ...
            std: [
                ...
                },
                {
                    ...
                    text: [
                        {
                            text: "A volume is a logical unit that you create to organize data into groups so that you can manage your data and apply policy all at once instead of file by file. The volume structure defines how data is distributed across the nodes in your cluster."
                        },
                        {
                            text: "You can create volumes for each user, department, or project. Volumes can enforce disk usage limits, set replication levels, establish ownership and accountability, and measure the cost generated by different projects or departments."
                        },
                        {
                            text: "Configure volumes as soon as you can after getting your cluster up and running. Putting all your data in the cluster without organizing it into volumes can lead to headaches later. It is important to create many volumes for data storage and to select your choice of volumes strategically for management. Volumes are easily created, named, and their mount path designated from the MapR Control System (MCS)."
                        },
                        {
                            text: "Volumes empower the following data management features that MapR provides:"
                        },
                        ...
                        {
                            text: "As shown in the example above, you should add a hierarchy of volumes for users, projects and departments, to enable you to manage data for these different entities separately."
                        }
                    ],
                    std: [
                        {
