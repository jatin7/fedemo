                                            ...
                                            ol: [
                                                    {
                                                        desc: "Click "
                                                                + img("hue_mm")
                                                                + ". The Metastore Manager page opens."
                                                    },
                                                    {
                                ...
                                ul: [
                                        ...
                                        },
                                        {
                                            ...
                                            ol: [
                                                     ...
                                                     * Name
                                                     * 
                                                     * Enter MapReduceJobDesign
                                                     * as the job name.
                                                     * 
                                                     * Description
                                                     * 
                                                     * Enter Job Design Tutorial
                                                     * as the descriptor.
                                                     * 
                                                     * JAR Path
                                                     * 
                                                     * Enter
                                                     * user/mapr/mapreducejob/oozie-examples-3.3.2-mapr.jar
                                                     * as the fully-qualified
                                                     * path to the JAR file with
                                                     * the classes that
